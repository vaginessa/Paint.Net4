namespace PaintDotNet.Tools
{
    ...
    internal class TransactedToolDrawingAgent<TChanges> : TransactedToolAgent<TransactedToolDrawingToken<TChanges>>
    {
        ...
        public TransactedToolDrawingAgent(string name) : base(name)
        {
        }
